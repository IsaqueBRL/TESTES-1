    ...
    function renderPopUpInsumos() {
        ...
        suprimentosList.forEach(sup => {
            ...
            tr.addEventListener('click', () => {
                ...
                // sequência sem precisar reabrir a lista a cada um. Dá um retorno visual rápido (fundo
                // verde piscando) pra confirmar que aquele item entrou, e o usuário fecha manualmente
                // (✕ ou clicando fora) quando terminar de escolher tudo que precisa.
                tr.classList.add('insumo-pop-row-adicionado');
                setTimeout(() => tr.classList.remove('insumo-pop-row-adicionado'), 700);
            });
