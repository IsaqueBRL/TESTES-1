        ...
        lista.forEach(p => {
            ...
            tr.innerHTML = `
                ...
                <td style="white-space:nowrap;">
                    ...
                    ${podeReceberOuCancelar ? `<button class="btn-action-prod btn-edit-prod" style="background-color:var(--color-accent-orange);" onclick="receberNotaFiscalDePedido('${p.key}')">🧾 Nota Fiscal</button>` : ''}
                    ${podeReceberOuCancelar ? `<button class="btn-action-prod btn-edit-prod" style="background-color:var(--color-positive);" onclick="registrarRecebimentoDePedido('${p.key}')">📦 Recebimento</button>` : ''}
