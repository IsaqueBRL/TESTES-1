import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
    ...
    window.abrirDetalhePedidoCompra = function(key) {
        ...
        document.getElementById('detalhe-pedido-acoes').innerHTML = `
            ...
            ${podeReceberFisico ? `<button type="button" class="btn-action-prod btn-edit-prod" style="background-color:var(--color-positive);" onclick="abrirModalRegistrarRecebimento('${key}')">📦 Registrar Recebimento</button>` : ''}
            ${podeReceberFiscal ? `<button type="button" class="btn-action-prod btn-edit-prod" style="background-color:var(--color-accent-orange);" onclick="receberNotaFiscalDePedido('${key}')">🧾 Lançar Nota Fiscal</button>` : ''}
