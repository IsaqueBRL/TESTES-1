import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
    ...
    function renderPopUpInsumos() {
        ...
        if(suprimentosList.length === 0) {
            container.innerHTML = `<tr><td colspan="6" style="padding: 20px; text-align: center; color:#6a6d70; font-family: inherit;">Nenhuma matéria-prima localizada no sistema.</td></tr>`;
            return;
        }
        ...
        if(suprimentosList.length === 0) {
            container.innerHTML = `<tr><td colspan="6" style="padding: 20px; text-align: center; color:#6a6d70; font-family: inherit;">Nenhuma matéria-prima encontrada para "${filtroBuscaPopUpInsumo}".</td></tr>`;
            return;
        }
        ...
        suprimentosList.forEach(sup => {
            ...
            tr.innerHTML = `
                ...
                <td class="col-descricao">
                    ...
                    ${jaEscolhido ? '<span class="insumo-pop-tag-adicionado">✓ adicionado</span><button type="button" class="btn-remove-insumo-pop-up" title="Remover este insumo da estrutura de consumo">✕</button>' : ''}
                </td>
